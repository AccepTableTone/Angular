...
describe("CoursesCardListComponent", () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      .then(() => {
        ...
        el = componentFixture.debugElement;
      });
  }));
  ...
  it("should display the course list", () => {
    ...
    const courseList = el.queryAll(By.css(".course-card"));

    expect(courseList).toBeTruthy("Could not find cards");
    expect(courseList.length).toEqual(12);
  });
